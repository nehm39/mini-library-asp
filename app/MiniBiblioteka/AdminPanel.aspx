<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="MiniBiblioteka.AdminPanel" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mini biblioteka - panel administracyjny</title>
            ...
            <div id="main">
                <div class="col main">
                    ...
                    <asp:ListView ID="lvBooks" runat="server" EnableModelValidation="True">
                        <ItemTemplate>
                            <div class="book">
                                <p class="short"><%# Eval("TYTUL") + ", " + Eval("AUTOR") + ", " + Eval("Wydawnictwo") + " " + Eval("ROK_WYDANIA")%> 
                                    ...
                                    <asp:LinkButton ID="lbEdit" runat="server" CommandName="edit" CommandArgument='<%# Eval("ID_KSIAZKI") %>' OnCommand="lbEdit_Command">Edytuj</asp:LinkButton>
                                    <asp:LinkButton ID="lbDelete" runat="server" CommandName="delete" CommandArgument='<%# Eval("ID_KSIAZKI") %>' OnCommand="lbDelete_Command">Usuń</asp:LinkButton>
                                </p>
                            </div>
                    ...
                    <div>
                        <br />
                        <asp:Label ID="Label3" runat="server" Text="Filtruj: "></asp:Label>
                        <asp:DropDownList BackColor="#dfdfdf" ID="dplFiltr" runat="server">
                            <asp:ListItem Text="autor" Value="0" />
                            <asp:ListItem Text="rok wydania" Value="1" />
                            <asp:ListItem Selected="True" Text="tytuł" Value="2" />
                            <asp:ListItem Text="wydawnictwo" Value="3" />
                        </asp:DropDownList>
                        <asp:TextBox ID="txbFiltr" BackColor="#dfdfdf" AutoPostBack="True" runat="server" OnTextChanged="txbFiltr_TextChanged"></asp:TextBox>
                    </div>
                ...
                <div class="col last">
                    ...
                    <div class="panel">
                        <asp:Panel ID="Panel1" runat="server">
                            Zalogowany jako: <asp:Label ID="lblLogged" runat="server"></asp:Label><br /><br />
                            <asp:Button ID="btnAddBook" runat="server" Text="Dodaj książkę" OnClick="btnAddBook_Click"/>
                            <br /><br />
                             <asp:Button ID="btnLogout" runat="server" Text="Wyloguj" OnClick="btnLogout_Click" />
                            <br />
                        <br />
                            <b>
                        <asp:Label ID="lblMessage" runat="server" visible="false" ForeColor="Green"></asp:Label></b>
</asp:Panel>
                    </div>
                </div>
                <div class="clr"></div>
